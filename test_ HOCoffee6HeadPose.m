% Testing Session of the classification framework exploiting WARCO on the HOCoffee dataset.
%
% REFERENCES
...
% parametres
train_dir       = './database/HOCoffee6HeadPose/train';% training path
test_dir        = './database/HOCoffee6HeadPose/test';% testing path
ds_name         = 'HOCoffee6HeadPose';
J               = 6;% number of classes
