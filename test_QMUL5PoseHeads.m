% Testing Session of the classification framework exploiting WARCO on the QMUL5PoseHeads dataset.
%
% REFERENCES
...
% parametres
train_dir       = './database/QMUL5PoseHeads/train'; % training path
test_dir        = './database/QMUL5PoseHeads/test';% testing path
ds_name         = 'QMUL5PoseHeads';
