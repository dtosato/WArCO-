function  [log_posterior] = Y_patch_testing_cbh(log_posterior,testing_set,kernel_reg,train_kernel,F,w,N,j,J,t,d)
% Test a patch model of WARCO with the CBH distance..
%
% USAGE
