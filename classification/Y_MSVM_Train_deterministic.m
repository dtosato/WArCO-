function [train_out,F,R,accuracy,w] = Y_MSVM_Train_deterministic(train,y,c1_rate,K,J,class_num_train,cv_idx)
% Learn the multiclass a SVM in the space of SPD matrices using the CBH distance.
%
% USAGE
%  [train_out,F,R,accuracy,w] = Y_MSVM_Train_deterministic(train,y,c1_rate,K,J,class_num_train,cv_idx)
%
% INPUTS
