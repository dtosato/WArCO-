function  [model,train_kernel,kernel_reg,w] = Y_patch_learning_cbh_deterministic(training_set,class_num_train,K,J,t,d,cv_idx)
% Learn a patch model of WARCO with the CBH distance.
%
% USAGE
...
[train_kernel,model,kernel_reg,~, w] =...
    Y_MSVM_Train_deterministic(ts_data,label_data,100,K,J,class_num_train,cv_idx);
