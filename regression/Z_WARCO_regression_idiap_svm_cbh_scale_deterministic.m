function Z_WARCO_regression_idiap_svm_cbh_scale_deterministic(root,train_dir,test_dir,ds_name,K,patch_dim,patch_overlap,n_row,n_col,scale,d,cv_idx)
% Regressor training and testing procedure exploiting WARCO with the CBH distance for the IDIAP data.
%
% USAGE
%  Z_WARCO_regression_idiap_svm_cbh_scale_deterministic(root,train_dir,test_dir,ds_name,K,patch_dim,patch_overlap,n_row,n_col,scale,d,cv_idx)
%
% INPUTS
%  root          - root path
    ...
    for t = 1:n_wins
        ...
        for a = 1:3
            ...
            [train_kernel{t,a},F{t,a},kernel_reg{t,a},~] = ...
                Y_MSVR_Train_deterministic(ts_data,label_data,0,K,cv_idx);
        end
