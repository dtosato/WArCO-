function [train_out,F,R,error] = Y_MSVR_Train_deterministic(train,y,c1_rate,K,cv_idx)
% Learn a kernel SVR in the space of SPD matrices using the CBH distance.
%
% USAGE
%  [train_out,F,R,error] = Y_MSVR_Train_deterministic(train,y,c1_rate,K,cv_idx)
% INPUTS
