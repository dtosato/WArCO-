function [testing_set] = X_build_testset_idiap_reg_svm(data_dir,~,or_label_test,patches,U,Id,d,FB,offset,scale)
% Build the regression testing set according to the patch-based model WARCO for the IDIAP data.
%
% USAGE
%  [testing_set] =  X_build_testset_idiap_reg_svm(data_dir,store_dir,patches,Id,d,FB,offset,scale)
%
% INPUTS
